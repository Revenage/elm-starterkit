...
var author$project$Main$getTranslation = function (lang) {
	return elm$http$Http$get(
		{
			expect: A2(elm$http$Http$expectJson, author$project$Main$HandleTranslateResponse, author$project$Decoders$decodeTranslations),
...
var author$project$Router$route = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
...
var author$project$Main$toRoute = function (string) {
	var _n0 = string.path;
	if (_n0 === '') {
		return author$project$Router$NotFound;
	} else {
		return A2(
			elm$core$Maybe$withDefault,
			author$project$Router$NotFound,
			A2(elm$url$Url$Parser$parse, author$project$Router$route, string));
	}
};
var author$project$Services$I18n$getLangString = function (lang) {
	switch (lang.$) {
		case 'English':
			return 'en';
		case 'Russian':
...
var author$project$Types$TranslateLoading = {$: 'TranslateLoading'};
var author$project$Main$init = F3(
	function (flags, url, key) {
		var route = author$project$Main$toRoute(url);
		return _Utils_Tuple2(
			{key: key, language: author$project$Types$English, route: route, translation: author$project$Types$TranslateLoading, url: url},
			author$project$Main$getTranslation(
				author$project$Services$I18n$getLangString(author$project$Types$English)));
	});
			...
			case 'HandleTranslateResponse':
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{translation: author$project$Types$TranslateFailure}),
						elm$core$Platform$Cmd$none);
				}
			default:
				return _Utils_Tuple2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$href('/404')
											]),
										_List_fromArray(
											[
												A2(
	...
	switch (_n0.$) {
		...
		case 'TranslateSuccess':
			var viewPage = function (pageview) {
				var _n3 = pageview(model);
				var title = _n3.title;
				var content = _n3.content;
				return {
					body: _List_fromArray(
						[
			...
			if (_n1.$ === 'Home') {
				...
				var _n2 = author$project$Pages$NotFound$view(
				...
				return {
					body: A2(
						elm$core$List$map,
						elm$html$Html$map(author$project$Main$MsgNotFound),
						body),
					title: title
				};
			}
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Types.Translation":{"args":[],"type":"Dict.Dict String.String String.String"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"MsgNotFound":["Pages.NotFound.Msg"],"HandleTranslateResponse":["Result.Result Http.Error Types.Translation"],"Back":[]}},"Pages.NotFound.Msg":{"args":[],"tags":{"NoOp":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});
...
},{}],"App/main.js":[function(require,module,exports) {
"use strict";
...
var app = _Main.Elm.Main.init({
  node: document.getElementById("app") //   flags: {
  //     settings
  //   }
...
// });
},{"./Main.elm":"App/Main.elm"}],"../../../../../usr/local/share/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../usr/local/share/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","App/main.js"], null)
//# sourceMappingURL=/main.4f8a0d0b.js.map